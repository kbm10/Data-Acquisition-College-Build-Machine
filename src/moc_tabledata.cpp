...
#include "../../FYP-2015-EEE/src/tabledata.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_tableData_t, stringdata) + ofs \
...
const QMetaObject tableData::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_tableData.data,
...
void *tableData::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tableData.stringdata))
